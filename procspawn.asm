...
main(int argc, char *argv[])
{
  ...
  33:	0f 8e 0b 01 00 00    	jle    144 <main+0x144>
    n = 1;       //default value
  else
  ...
  if ( n < 0 || n > 20 )
  4c:	0f 86 fc 00 00 00    	jbe    14e <main+0x14e>
    n = 2;
  ...
  5d:	83 c3 01             	add    $0x1,%ebx
      ...
      printf(1, "Fork Failed\n");
  60:	68 56 08 00 00       	push   $0x856
  65:	6a 01                	push   $0x1
  67:	e8 84 04 00 00       	call   4f0 <printf>
  ...
  74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    id = fork ();
  78:	e8 1d 03 00 00       	call   39a <fork>
    if(id == 0) {
  ...
  a0:	e8 9d 03 00 00       	call   442 <cps>
  ...
  b1:	83 c3 01             	add    $0x1,%ebx
    printf(1, "W%d\n", k);
  b4:	6a 01                	push   $0x1
  b6:	e8 35 04 00 00       	call   4f0 <printf>
    wait();
  bb:	e8 ea 02 00 00       	call   3aa <wait>
    }
  }
  ...
  exit();
  c7:	e8 d6 02 00 00       	call   3a2 <exit>
  id = 0;
  for ( k = 0; k < n; k++ ) {
    id = fork ();
    if(id == 0) {
  ...
  cc:	e8 51 03 00 00       	call   422 <getpid>
  d1:	51                   	push   %ecx
  d2:	50                   	push   %eax
  d3:	68 1b 08 00 00       	push   $0x81b
  d8:	6a 01                	push   $0x1
  ...
  fc:	83 c4 10             	add    $0x10,%esp
        for(x=0; x<40000.0; x+=0.1) {
  ff:	dd 05 68 08 00 00    	fldl   0x868
 105:	dd 45 e0             	fldl   -0x20(%ebp)
 108:	d9 ca                	fxch   %st(2)
 10a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 110:	d8 c1                	fadd   %st(1),%st
 112:	d9 05 70 08 00 00    	flds   0x870
 118:	df e9                	fucomip %st(1),%st
 ...
 11c:	dd d8                	fstp   %st(0)
    ...
    if(id == 0) {
      ...
      for(y=0; y<400.0; y+=0.1) {
 11e:	de c1                	faddp  %st,%st(1)
 120:	d9 05 74 08 00 00    	flds   0x874
 126:	df e9                	fucomip %st(1),%st
 128:	77 be                	ja     e8 <main+0xe8>
 12a:	dd d8                	fstp   %st(0)
          z+= x;
	  // while(z>0) z--;
        }
      ...
      printf(1, "Child completed %d\n", getpid());
 12c:	e8 f1 02 00 00       	call   422 <getpid>
 131:	52                   	push   %edx
 132:	50                   	push   %eax
 133:	68 2f 08 00 00       	push   $0x82f
 138:	6a 01                	push   $0x1
 13a:	e8 b1 03 00 00       	call   4f0 <printf>
 ...
 149:	e9 09 ff ff ff       	jmp    57 <main+0x57>
    n = atoi ( argv[1] ); //from command line
  if ( n < 0 || n > 20 )
    n = 2;
  x = 0;
 ...
 150:	0f 85 01 ff ff ff    	jne    57 <main+0x57>
    } else if(id<0) {
      printf(1, "Fork Failed\n");
    }
  }
  ...
  cps();
 156:	e8 e7 02 00 00       	call   442 <cps>
 15b:	e9 67 ff ff ff       	jmp    c7 <main+0xc7>
...
00000690 <free>:
 ...
 6e9:	a3 20 0b 00 00       	mov    %eax,0xb20
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 6f1:	5d                   	pop    %ebp
 ...
 70d:	a3 20 0b 00 00       	mov    %eax,0xb20
...
00000720 <malloc>:
 ...
 781:	39 05 20 0b 00 00    	cmp    %eax,0xb20
 ...
 7ab:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 7cf:	89 15 20 0b 00 00    	mov    %edx,0xb20
 ...
 7e6:	c7 05 20 0b 00 00 24 	movl   $0xb24,0xb20
 7ed:	0b 00 00 
 7f0:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 7f7:	0b 00 00 
 7fa:	b8 24 0b 00 00       	mov    $0xb24,%eax
 7ff:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 806:	00 00 00 
