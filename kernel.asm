...
8010373a:	68 78 75 10 80       	push   $0x80107578
...
80103fdb:	68 bb 78 10 80       	push   $0x801078bb
...
80104008:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104083:	56                   	push   %esi
    ...
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
80104084:	be 40 75 10 80       	mov    $0x80107540,%esi
  }
}
...
80104095:	74 34                	je     801040cb <cps+0x4b>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104097:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010409a:	ba 40 75 10 80       	mov    $0x80107540,%edx
  //uint pc[10];
...
801040a1:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
801040af:	ff 73 a4             	pushl  -0x5c(%ebx)
801040b2:	68 44 75 10 80       	push   $0x80107544
801040b7:	e8 a4 c5 ff ff       	call   80100660 <cprintf>
    cprintf("\n");
801040bc:	c7 04 24 bb 78 10 80 	movl   $0x801078bb,(%esp)
801040c3:	e8 98 c5 ff ff       	call   80100660 <cprintf>
801040c8:	83 c4 10             	add    $0x10,%esp
801040cb:	83 c3 7c             	add    $0x7c,%ebx
  //int i;
  struct proc *p;
  char *state;
  //uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ce:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040d4:	75 ba                	jne    80104090 <cps+0x10>
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    cprintf("\n");
  }
...
801040d9:	b8 16 00 00 00       	mov    $0x16,%eax
801040de:	5b                   	pop    %ebx
801040df:	5e                   	pop    %esi
801040e0:	5d                   	pop    %ebp
801040e1:	c3                   	ret    
...
801040fa:	68 b8 75 10 80       	push   $0x801075b8
...
80104335:	68 da 75 10 80       	push   $0x801075da
...
80104342:	68 c3 75 10 80       	push   $0x801075c3
...
80104423:	68 e1 75 10 80       	push   $0x801075e1
...
8010446c:	68 e9 75 10 80       	push   $0x801075e9
...
8010489a:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
...
801048c0:	68 f1 75 10 80       	push   $0x801075f1
...
80104a24:	68 98 76 10 80       	push   $0x80107698
...
80104a3c:	68 97 76 10 80       	push   $0x80107697
...
80104e7d:	58                   	pop    %eax
80104e7e:	5a                   	pop    %edx
80104e7f:	68 98 76 10 80       	push   $0x80107698
...
80104e98:	68 97 76 10 80       	push   $0x80107697
...
80105709:	68 dd 76 10 80       	push   $0x801076dd
...
801057a0:	ff 24 85 84 77 10 80 	jmp    *-0x7fef887c(,%eax,4)
...
80105805:	68 40 77 10 80       	push   $0x80107740
...
801058ef:	68 e8 76 10 80       	push   $0x801076e8
...
801059a8:	68 0c 77 10 80       	push   $0x8010770c
801059ad:	e8 ae ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059b2:	83 c4 14             	add    $0x14,%esp
801059b5:	68 e2 76 10 80       	push   $0x801076e2
...
80105aaf:	bb 04 78 10 80       	mov    $0x80107804,%ebx
...
801066bd:	68 0c 78 10 80       	push   $0x8010780c
...
80106a09:	68 51 78 10 80       	push   $0x80107851
...
80106abd:	68 6b 78 10 80       	push   $0x8010786b
80106ac2:	e8 a9 98 ff ff       	call   80100370 <panic>
80106ac7:	83 ec 0c             	sub    $0xc,%esp
80106aca:	68 0c 79 10 80       	push   $0x8010790c
...
80106b61:	68 89 78 10 80       	push   $0x80107889
...
80106b93:	68 a1 78 10 80       	push   $0x801078a1
...
80106c7c:	68 bd 78 10 80       	push   $0x801078bd
...
80106d4f:	68 ce 78 10 80       	push   $0x801078ce
...
80106e45:	68 f2 78 10 80       	push   $0x801078f2
80106e4a:	e8 21 95 ff ff       	call   80100370 <panic>
80106e4f:	83 ec 0c             	sub    $0xc,%esp
80106e52:	68 d8 78 10 80       	push   $0x801078d8
